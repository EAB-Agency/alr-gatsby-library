...
import SchoolContentFive from 'components/school-content/school-content-5';
...
<div className="intro-wrap">
  ## School Content 3
  Basic school content layout, use when there is not a lot of copy. 
</div>
...
<div className="intro-wrap">
  ## School Content 4
  Aside element can be used for img content as well, uncomment from html if needed. 
</div>
