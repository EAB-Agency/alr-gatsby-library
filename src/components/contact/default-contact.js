		...
		<div className="center lp-school-wrapper">
			<div className="lp-school-contact-info">
				<div className="lp-school-contact-intro">
					...
					<p>Earning your master’s degree is an important step in your career, and we are here to support you. Don’t hesitate to reach out to get answers to any questions you may have!</p>
