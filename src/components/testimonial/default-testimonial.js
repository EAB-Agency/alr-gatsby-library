  ...
  <div className="social-proof">
    <div className="center">
      <div className="social-proof-quote">
        <div className="img-wrap"><img alt="Sneha Soni" className="social-proof-photo" height="100" width="100" src="https://admiss.info/assets/lp-live/1537-hoo-g-live/img-sneha.jpeg" /></div>
        ...
        <footer><cite>— Meghan Munsey, Associate Director of First Year Experience, MBU&nbsp;Online</cite></footer>
        </blockquote>
      </div>
    </div>
  </div>
