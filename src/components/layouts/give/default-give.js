            ...
            <div className="lp-intro-form-content">
                <div className="lp-intro">
                    ...
                    <div className="intro-copy">
                        <p>
                            Copy that introduces the content give and highlights
                            what it's all about. Lorem ipsum dolor sit amet,
                            consectetur adipiscing elit. Integer vestibulum
                            lacus et elit commodo, non gravida orci fringilla.
                            Nulla nec quam sed velit commodo pulvinar sed sed
                            quam.
                        </p>
                    </div>
                </div>
                ...
                <div className="lp-form">
                    <div
                        className="lp-form-initial form-initial"
                        id="form-initial"
                    >
                        <div className="lp-form-intro">
                            <p>
                                Fill out the information below, and once you hit
                                the "Access My Guide" button, you'll be able to
                                download your guide.
                            </p>
                        </div>
